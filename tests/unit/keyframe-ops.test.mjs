...
} from '../../src/renderer/features/timeline/keyframe-ops.js';
...
describe('keyframe-ops', () => {
  ...
  describe('buildSplitAnchorKeyframe', () => {
    ...
    test('inherits camera state from parent section anchor', () => {
      const keyframes = [
        { time: 0, pipX: 50, pipY: 60, pipVisible: false, cameraFullscreen: true, backgroundZoom: 1.5, backgroundPanX: 0.3, backgroundPanY: -0.2, sectionId: 'parent-1', autoSection: true },
      ];
  ...
  describe('split preserves existing keyframe states', () => {
    test('splitting adds one keyframe without modifying existing ones', () => {
      ...
      const newAnchor = buildSplitAnchorKeyframe(keyframes, 's-2', newId, 7.5, defaults);
